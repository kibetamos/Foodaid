...
<div class="container mt-5">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <td><a href="{{action('App\Http\Controllers\donationController@edit', $donation->id)}}" class="btn btn-primary">Edit</a></td>

          <td> <form action="{{action('App\Http\Controllers\donationController@destroy', $donation->id)}}" method="post"onSubmit="return confirm('Are you sure to delete?')">
                    {{csrf_field()}}
