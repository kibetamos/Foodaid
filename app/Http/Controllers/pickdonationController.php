...
class pickdonationController extends Controller
{
    /**
...
'food_description'=>$request->food_description
            ...
            return redirect ('/pickdonation')->with('success', 'Donation has been made successfully ');
    }
    ...
    public function show( Donation $donation)
    {
      ...
      return redirect ('/picked')->with('success', 'The agency has picked the donation');
    }
